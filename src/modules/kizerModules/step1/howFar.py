...
class HowFar(object):
    ...
    def __init__(self):
        ...
        self.CityNumber = int() #dallas=221
        self.minRoughnessOption = "N"
    ...
    # min roughness (Y or N)
    def setMinRoughness(self, option):
        self.minRoughnessOption = option.upper()
    ...
    def execute(self):
        # open main folder
        # self.ExampleS3FolderPath = "C:/Users/sixpa/tdx/ExampleS1"

        # Create file paths using main folder path
        OutputFilePath = self.ExampleS3FolderPath + "/Output.csv"
        CitiesFilePath = self.ExampleS3FolderPath + "/Cities.csv"
        RRCurvesFolderPath = self.ExampleS3FolderPath + "/RRCurves"
        RadiosFilePath = self.ExampleS3FolderPath + "/Radios.csv"

        # self.CityNumber = 221
        print("Check folder path and cities.csv: ", CitiesFilePath)
        ...
        if not (str(row[0]) == str(self.CityNumber)):
            print("The city number " + self.CityNumber + " could not be found.")
            sys.exit()
        ...
        # self.minRoughnessOption = input("Do you want to use minimum roughness (20 feet)? (y or n) ")
        self.minRoughnessOption = "N"

        if (self.minRoughnessOption.upper == "Y"):
            Roughness = "20"
            #Roughness# = 20?
