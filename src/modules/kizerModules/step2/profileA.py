...
class ProfileA(object):
    ...
    def createProfile(self, InputFolder,OutFolder,InFolder):                 #900
        ...
        for index, row in input_df.iterrows():
            ...
            PrintScriptOutput.write(OutFolder + "\Plotter\\" + "pgnuplot.exe SC" + str(ProfileNumber) + ".gp\n" )

            Flag2 = self.createScripts(InFolder,OutFolder,ProfileNumber,CleanUpScriptFile,TowerHeight1,TowerHeight2,AntennaHeight1,AntennaHeight2,PathDistance,Site1,Site2) #Create scripts

            self.createDataFiles(InFolder, OutFolder,ProfileNumber,CleanUpScriptFile,Flag2,AntennaHeight1 ) #Create data files
    ...
    def createScripts(self, InFolder, OutFolder,ProfileNumber,CleanUpScriptFile,TowerHeight1,TowerHeight2,AntennaHeight1,AntennaHeight2,PathDistance,Site1,Site2): #1000
        ...
        MainScriptFile.write("set xrange [-{} to {}]\n".format(LeftPoint,RightPoint))
        ...
        for index3 in range(0,ev_length):
            ...
            if(LocationCounter == 1):
                ...
                MainScriptFile.write("set arrow nohead from " + str(Dist2) + "," + str(Elev) + " to " + str(Dist2) + "," + Elev2 + "\n")
                continue
            ...
            if(ObCode == "B"):
                ...
                MainScriptFile.write("set arrow nohead from " + str(Dist2) + "," + Ht0Down + " to " + str(Dist2) + "," + Ht0Up + "\n")
                MainScriptFile.write("set arrow nohead from " + str(Dist2) + "," + Ht1Down + " to " + str(Dist2) + "," + Ht1Up + "\n")

                if(Flag2 == 1):
                    MainScriptFile.write("set arrow nohead from " + str(Dist2) + "," + Ht2Down + " to " + str(Dist2) + "," + Ht2Up + "\n")
            ...
            if(ObCode == "T"):
                ...
                MainScriptFile.write("set arrow head from " + str(Dist2) + "," + Ht0Down + " to " + str(Dist2) + "," + Ht0Up + "\n")
                MainScriptFile.write("set arrow head from " + str(Dist2) + "," + Ht1Down + " to " + str(Dist2) + "," + Ht1Up + "\n")

                if(Flag2 == 1):
                    MainScriptFile.write("set arrow head from " + str(Dist2) + "," + Ht2Down + " to " + str(Dist2) + "," + Ht2Up + "\n")

        del ev_df
        del pr_df
        Elev2 = float(Elev) + float(TowerHeight2)
        Elev2 = str(Elev2)
        MainScriptFile.write("set arrow nohead from " + str(Dist2) + "," + Elev + " to " + str(Dist2) + "," + Elev2 + "\n")
    ...
    def execute(self):
        ...
        ### User input 1 ###
        # self.FolderPath = "E:\Path Design 11 April 2021\Step 2 Profile Programs\ExampleStep2A"
        ...
        if(SysOpt == "Y"):
            ...
            self.createProfile(InputFolder,OutFolder,InFolder)
