...
class PathsAUI2(QWidget):

    def __init__(self, parent=None):
        super(PathsAUI2, self).__init__(parent)
    ...
    def savedLocationUI(self, parent):
        ...
        self.savedLocationLabel.setText("Location where files are saved:")
        ...
        self.savedLocationLabel.setFixedWidth(self.screenWidth*0.4)
        ...
        self.savedLocationTextBox.setFixedWidth(self.screenWidth*0.2)
