...
class KML3DAUI3(QWidget):

    def __init__(self, parent=None):
        super(KML3DAUI3, self).__init__(parent)
    ...
    def parametersUI(self, parent):
        ...
        self.backBtn.clicked.connect(lambda: parent.screenTransition.kml3daTwo(parent)) # validate the rows
    ...
    def nextBtnClicked(self, parent):
        parent.screenTransition.backToHome(parent)
